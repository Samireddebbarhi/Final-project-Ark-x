<<<<<<< HEAD:client/src/pages/ListCategory.jsx
...
const Categorylist = () => {
  ...
  const indexOfLastCategory = currentPage * categoriesPerPage;
  const indexOfFirstCategory = indexOfLastCategory - categoriesPerPage;
  const currentCategories = pCatStat.slice(
      ...
      <div>
        <div className="py-8">
          ...
          <div className="flex justify-center space-x-1 dark:text-gray-800 py-8">
            ...
            {Array.from(
              { length: Math.ceil(pCatStat.length / categoriesPerPage) },
              (_, i) => (
                <button
                  key={i}
                  onClick={() => setCurrentPage(i + 1)}
            ...
            <button
              ...
              onClick={() => setCurrentPage(currentPage + 1)}
              disabled={
                currentPage === Math.ceil(pCatStat.length / categoriesPerPage)
              }
            >
              <svg
                viewBox="0 0 24 24"
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form
                      className="p-4 md:p-5"
                      onSubmit={
                        isEditing === true ? handleUpdate : handleSubmit
                      }
                    >
                      <div className="grid gap-4 mb-4 grid-cols-2">
                        <div className="col-span-2">
                      ...
                      >
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            d="M10 5a1 1 0 011 1v3h3a1 1 0 1 1 0 2h-3v3a1 1 0 1 1-2 0v-3H6a1 1 0 1 1 0-2h3V6a1 1 0 011-1z"
                            clipRule="evenodd"
                          ></path>
                        </svg>
                        {isEditing === true
...
export default Categorylist;
>>>>>>> a7fa1cf22d1605af6d30e711dbef0ea8791ebf09:client/src/pages/Categorylist.jsx
