...
import { FaRegUser, FaShoppingCart } from "react-icons/fa"; // Import the shopping cart icon
          ...
          <div className="flex-1 md:flex md:items-center md:justify-between" id="navbarSupportedContent">
            <div className="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
              ...
              <Link to="/base/mobiles"
                className="px-2 py-1 mx-2 mt-2 text-md font-medium text-gray-800 dark:text-gray-300 hover:text-gray-200 transition-colors duration-200 transform rounded-md md:mt-0"
              >
                Mobiles
              </Link>
            ...
            </div>
            {
              isLogged ? (
                <div className="flex items-center mt-4 md:mt-0">
                  ...
                  <Link to="/base/cart"> {/* Wrap the cart icon with Link */}
                    <button
                      className="mx-4 text-gray-600 transition-colors duration-200 transform md:block dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none"
                      aria-label="show notifications"
                    >
                  ...
                  <button className="mx-4 text-gray-600 transition-colors duration-200 transform md:block dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none" onClick={handleLogout}>
                    Logout
                  </button>
                </div>
              ) : (
